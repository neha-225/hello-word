...
class Common_model extends MY_Model {
    ...
    /* Exceute a custom build query by query binding- 
     * Useful when we are not able to build queries using CI DB methods
     * Prefreably to be used in SELECT queries
     * The main advantage of building query this way is that the values are
     * automatically escaped which produce safe queries.
