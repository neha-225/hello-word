        ...
        <tr>
            <td style="text-align: center; background: #fff;">
                <table width="100%" border="0" cellpadding="30" cellspacing="0">	
                    <tr>
                        <td>
                            <img style="padding: 10px;" height="100" src="<?php echo base_url().PARKSWAP_LOGO; ?>LOGO4.png">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">You Recently requested to reset your password for your ParkSwap account. Please use password given below to login: </p>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Thanks,<br>Team ParkSwap</p>  
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="text-align: center;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td style="padding: 10px;background: #f0d560;color: #1c1919;"><?php echo COPYRIGHT; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
